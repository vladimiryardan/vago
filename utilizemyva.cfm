...
<style type="text/css">
	.page_title {
	    ...
	    background: #fff url(images/blogImages/utilize.jpg) no-repeat center top;
...
<!---##########BODY##########--->
	...
	<div class="container">
	<h5>
		As a busy entrepreneur with clients all over the globe, I find travel is a giant part of my life. 
		I love working from wherever there is wifi. The laptop lifestyle is an amazing way to live. I 
		bring my MacBook Air, and work from 38k feet altitude, wherever life is taking me next.
	</h5>
	
    	<h5>
    		This month, I was preparing for my most recent trip, my assistant and I had a check-in call, 
    		and a friend overheard it. As my assistant and I went through all the pre-trip planning and 
    		preparation she’d compiled and completed, my friend was astonished. He said, “I’ve never 
    		thought of asking a VA to do something like that before.”
    	</h5>
    	
    	<h5>
    		Our protocol is one I developed with a few of my VAs as I’ve changed staff over the last few 
    		years. I started thinking about the things that stressed me out when I travel, and what would 
    		help me have a “soft landing” -- being able to feel the most “at home” when I landed in my 
    	...
    	<h5>
    		Amazing, right? All of this preparation happens automatically, and usually my VA and I have a 
    		check-in call the day before I leave to make sure all is in place. (Usually it’s a reminder 
    		for me to pull out a dress for an event, run the robot vacuum, or make sure I packed gym 
    		clothes.) You don’t have to copy this protocol exactly, but having a template can be helpful!
    	</h5>
...
<!---##########End Body##########---> 
    	...
    	<h4 style="margin-top:50px; color:darkblue;">
    		...
    		<a href="http://www.charissamoore.com/blog/travel-planning" target="_blank" </a> www.charissamoore.com
    	</h4>
	</div>
</div>
