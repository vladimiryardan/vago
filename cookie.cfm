...
<style type="text/css">
	...
	background: #fff url(images/cookie.jpg) no-repeat center top;
...
<div class="container">
	<div class="one_full stcode_title12">
    	...
    	<h5>
    		...
    		Information" we collect may include your Internet Protocol (“IP“) address, computer/mobile 
    		device operating system and browser type, type of mobile device, the characteristics of the 
    		mobile device, the unique device identifier (“UDID“) or mobile equipment identifier (“MEID“) 
    		for your mobile device, the address of a referring web site (if any), and the pages you visit 
    		on our Sites and Mobile Apps, and the times of visit. We may use this information for any and 
		...
		<h5 style="padding:0px 100px 0px 100px;">
			...
			features and content for you and to remember how you’ve customized the Service in other
		...
		<h5 style="padding:0px 100px 0px 100px;">
			...
			to track your device’s browsing activity on other sites or services other than Virtual Assistant 
			GO.
			This information may be shared with organizations outside Virtual Assistant GO, such as 
			advertisers
