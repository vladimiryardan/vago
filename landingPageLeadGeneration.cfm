...
<style type="text/css">
	...
	@media only screen and (max-height: 1200px) and (max-width: 1200px)
	{
	
	}
	
	@media only screen and (max-height: 1300px) and (max-width: 1300px)
	{
		.quote
	{
		margin-top:-95%;
...
<body>
	...
	<div class="page_title" style="padding-top:0px;">
		...
		<div class="titleBody one_half" style="margin-left:5%; padding-top:15%; color:white; ">
			<div class="customBackground" style="background-color:rgb(0,0,0,0.6); padding-top:2%;">
		...
		<div class="one_half last" style="float:right; margin-top:-23%; height:100%;">
		 <div class="quote" style="background-color:rgb(0,0,0,0.6); padding-left:2%; margin-left:20%; margin-right:19%;">
			<h1 style="color:white;">
				Quick Quote
			</h1>
		
		<div class="input-group">
		  <input type="text" class="depth" id="Username" placeholder="Name"; style="width:100%; margin-left:-5%;"/>
		  <br>
		  <input type="text" class="depth" id="Email" placeholder="Email" style="margin-top:-15px; width:100%; margin-left:-5%;"/>
		  <br>
		  <input type="text" class="depth" id="Phone" placeholder="Phone" style="margin-top:-15px; width:100%; margin-left:-5%;"/>
		  <br>
		  <textarea type="text" class="depth" id="Comment" placeholder="What do you need?" style="margin-top:-15px; width:100%; margin-left:-5%;"></textarea>
		  <br>
	...
	<!---Modal --->
	<label class="modal" for="modal-control" style=" display:none">Show modal</label>
