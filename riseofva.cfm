...
<div class="container">
		...
		<div class="ms-layer centext text1 white" data-ease="easeOutExpo">
            <strong>Rise of Virtual Assistant</strong>
        </div>
...
<br>
	...
	<div class="container">
    	...
    	<h5>
    		...
    		assistants don't belong to any official organization or networking group. However, a large 
    		number of VAs have joined freelancing platforms. There are more than 5,000 virtual assistants 
    	...
    	<h4 style="margin-top:50px; color:darkblue;">
    		...
    		<a href="http://theweek.com/articles/732973/rise-virtual-assistant" target="_blank" </a> www.theweek.com
    	</h4><br>
	</div>
</div>
