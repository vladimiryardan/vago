<!DOCTYPE html>
<!-- saved from url=(0020)https://minicss.org/ -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<link href="./mini.css - Minimal, responsive, style-agnostic CSS framework_files/css" rel="stylesheet">
<link rel="stylesheet" href="./mini.css - Minimal, responsive, style-agnostic CSS framework_files/style.min.css">
...
<meta property="og:url" content="https://chalarangelo.github.io/mini.css/"><link rel="icon" type="image/png" href="https://minicss.org/favicon.png">
</head>
<body>
...
<a class="button splash" href="https://minicss.org/docs">Get started</a>
</div>
<header class="row sticky">
<span class="col-md-1 col-lg-2"></span>
<span class="logo col-sm-3 col-md">mini.css</span>
<a class="button col-sm col-md" href="https://minicss.org/docs">
...
<span>&nbsp;Github</span></a>
<a class="button col-sm col-md" href="https://minicss.org/flavors">
...
<img src="./mini.css - Minimal, responsive, style-agnostic CSS framework_files/responsive.svg" class="feature-image">
...
<div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
<img src="./mini.css - Minimal, responsive, style-agnostic CSS framework_files/tailored.svg" class="feature-image">
