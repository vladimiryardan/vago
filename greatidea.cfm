...
<div class="container">
		...
		<div class="ms-layer centext text1 white" data-ease="easeOutExpo">
            <strong>Virtual Assistant Is a Great Idea </strong>
        </div>
...
<div class="title2" style="margin-top:50px;">
	...
	<div class="container">
    	...
    	<p>
    		...
    		contractors, they are solely responsible for their own benefits and taxes.
    		Furthermore, businesses that offer virtual assistant services have the opportunity to grow 
    		their company. IT companies can provide virtual assistants to those businesses abroad that 
    		want to delegate tasks to professionals via the cloud. This way, businesses offering virtual 
    		assistant services can have additional income helping them to expand and to match the rising 
