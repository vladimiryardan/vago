...
<html lang="en">
	...
	<body cz-shortcut-listen="true">
		...
		<div class="index-splash vago">
			  ...
			  <h1 class="splash">Lead Generation</h1>
		
			  <p class="splash" style="font-size:19px;">Generate high-quality Leads with the help of <br>
	              ...
	              <fieldset>
	                <div class="row">
	                  ...
	                  <div class="col-sm-12 col-md-12">
	                    <input class="depth" type="text" id="leademl" name="leademl" placeholder="Email" required="required">
	                  </div>
	                  <div class="col-sm-12 col-md-12">
